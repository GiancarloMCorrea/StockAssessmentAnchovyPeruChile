#C Namibian Hake from Pollacheck 1993
#simplified-see notes in folder
Mod.dat
newMod.ctl
0 # changed from 1 to 0; 0=use init values in control file; 1=use ss3.par
...
0 # Number of bootstrap datafiles to produce: 1st is input, 2nd is estimates, 3rd and higher are bootstrap
