...
0   0   0   0      #Fishery Peru
0   0   0   0      #Fishery Chile
0   0   0   2      #Ind1
0   0   0   2      #Ind2

##Q para cada indice
-4   4   -0.8     0   -1   99   2  # Ind1
-4   4   -0.8     0   -1   99   2  # Ind2

#Seltype(1,2*Ntypes,1,4)    #SELEX_&_RETENTION_PARAMETERS
#Size_Slectivity,_enter_4_cols
#N_sel  Do_retain   Do_male Special
1      0           0       0   #Fishery Peru
1      0           0       0   #Fishery Chile
0      0           0       0   # Ind1
30      0           0       0   # Ind2

#Age_selectivity    #set_to_1
10      0           0       0   #Fishery Peru
10      0           0       0   #Fishery Chile
10      0           0       0   #Ind1
10      0           0       0   #Ind2
...
# fishery
#LO      HI     INIT    PRIOR    PR_type    SD    PHASE    env-variable   use_dev  dev_minyr  dev_maxyr   dev_stddev    Block_Pattern    Block_Type            
0		14.0	11.0	 9.0	   	-1	   0.05	    4	        0	         0	       0	      0	       0.5	        0	0	#
0		8.0		3.0		 0.7		-1	   0.05	    4	        0	         0	       0	      0	       0.5	        0	0	#
