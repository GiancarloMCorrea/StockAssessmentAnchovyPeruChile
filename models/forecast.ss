...
0.55 # SPR target (e.g. 0.40)
0.5 # Biomass target (e.g. 0.40)
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 2017 2017 2017 2017 2017 2017 1984 2017 1984 2017
...
1997 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
2018 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
